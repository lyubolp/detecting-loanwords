...
class TranscriptionDataset(Dataset):
    ...
    """
    def __init__(self, filepath: str, tokenization_src=None, tokenization_tgt=None,
    ...
    def __getitem__(self, idx):
        ...
        return self.__tokenization_src(word), self.__tokenization_tgt(transcription)
